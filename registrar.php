    ...
    <div class="glass-container">
      <form action="registrar.php" method="post" class="form" id="registerForm">
        ...
        <div class="input-wrapper">
          <input type="text" name="nombre" id="nombre" placeholder="Nombre real"
            value="<?php echo isset($_POST['nombre']) ? htmlEscape($_POST['nombre']) : ''; ?>" required>
          <div class="validation-box" id="nombreMsg"></div>
        </div>


        <div class="input-wrapper">
          <input type="text" name="usuario" id="usuario" placeholder="Nombre de usuario (3-20 caracteres)"
            value="<?php echo isset($_POST['usuario']) ? htmlEscape($_POST['usuario']) : ''; ?>" required>
